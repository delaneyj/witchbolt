...
func newStatsCommand() *cobra.Command {
	statsCmd := &cobra.Command{
		Use:   "stats <witchbolt-file>",
		Short: "print stats of witchbolt database",
...
experience corruption, please submit a ticket to the etcd-io/witchbolt project page:

  https://github.com/etcd-io/witchbolt/issues
`, "\n"),
